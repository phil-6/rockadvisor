...
<header class="intro-header">
    <div class="header-content">
        <div class="header-content-inner">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-10 text-center">
                            <div class="service-box">
                                ...
                                <p class="text-muted">Calum is a climber. You know this straight away as he lives in a
                                    ...
                                    have been slowly solidifying over the last decade or so of climbing definitely helps
                                    . When Calum isn’t climbing he can usually be found lurking in the dark corners of
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-10 text-center">
                            <div class="service-box">
                                ...
                                <p class="text-muted">Phil is an outdoorsperson through and through. Here outdoorsperson
                                    ...
                                    Phil's main focus in the Rock Advisor app is on the web and database portion of the
                                    project.
                                </p>
                            </div>
                        </div>
            ...
            <!--            </div>--><!-- bootstrapping -->
            <hr>
            <a href="#background" class="btn btn-default btn-xl">Read Up</a>
    ...
    <div class="row">
        <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
            ...
            <div class="post">
                ...
                <div class="postContent">
                    <p>
                        So over this last weekend I built a front end. Took about 36 hours of the available 48 but it
                        was worth it. The site has an attractive front page - heavily reliant on bootstrap but with a
                        lot of my own tweaks and changes. The map lots its ugly old side bar for controls and the filter
                        buttons are now controlled, positioned and styled by the google maps API.
                    </p>
                    <p>
                        RockAdvisor.uk and RockAdvisor.co.uk now belong to me and both have simple redirects set up that
                        point the URLs to where the site is actually hosted at csRockAdvisor.swansea.ac.uk. The only
                        thing that wasn’t completed over the weekend was the “contact us” form for anyone who wants to
                        help out by becoming a contributor in the early stages. Building a modal form was quite easy but
                        I got stuck on how to get email to send in the laravel php back end. 30 minutes with the ever
                        helpful Liam O’Reilly got the back end sorted. It took another 3 hours to hunt down all the bugs
                    ...
                    <p>
                        Next step is to take the data from our api and build a page that displays crags nicely. Maybe
            ...
            <div class="post">
                ...
                <h2 class="postTitle" id="background">
                    Background
                </h2>
                <div class="postContent">
                    <p>
                        Welcome to the Development blog for Rock Advisor. If you’ve made it this far you’ve obviously
                        shown
                    ...
                    <hr>
                    <p>
                        So a bit about the project. Rock Advisor is a final year dissertation project for Calum McClune
                    ...
                    <p>
                        The project title is still accurate but pretty much everything else has changed. While SWMC do
                        host a fantastically detailed set of Wiki pages covering all of South Wales, getting the data
                        they have out of their wiki is entirely non trivial. To solve this problem the decision was made
                        to start from the ground up. Build a database to hold all the information we want, then build a
                        front end to let people view that data and other CRUD functions. Then using the handy API we’re
                        going to build we allow people to view all the information in a mobile app!
                    </p>
                    <p>
                        That takes us to about the end of January, where we had scoped out the project again and worked
                        out WHAT we needed to do, we just then needed to work out HOW to do it. After those pesky final
                        year exams there and a project supervisor change there was a bit of a delay. But thanks in no
                        small part to a LOT of help from Liam O’Reilly by mid February we had the database designed and
                    ...
                    <hr>
                    <p>
                        Right then, after all that waffle that brings us to now, the end of February. The dissertation
                        progress reports are done with so that leaves us with a bit of a gap. Instead of progress log I
                        thought it would be a nice idea to have some occasional ramblings from Calum and myself about
                    ...
                    <p>
                        ...
                        written however we damn well please and will probably include expletives and spelling erros and
...
<!-- Footer --> <!-- as if that wasn't obvious!-->
<footer>
    <div class="container">
        <div class="row">
            <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
